                ...
                <form id="form-mesa">
                    <ion-list>
                        <ion-item>
                            ...
                            label="Descrição da Mesa" label-placement="floating" value="4" required>
                            </ion-input>
                        </ion-item>
                         <ion-item>
                            <ion-input type="text" name="qtd_cadeiras"
                            label="Descrição da Mesa" label-placement="floating" value="6" required>
                            </ion-input>
                        </ion-item>
                         <ion-item>
                            <ion-input type="text" name="qtd_cadeiras"
                            label="Descrição da Mesa" label-placement="floating" value="8" required>
                            </ion-input>
                        </ion-item>
                    </ion-list>
